...
.run(function($ionicPlatform, $cordovaSQLite) {
  $ionicPlatform.ready(function() {
    ...
    $cordovaSQLite.execute(db, "CREATE TABLE IF NOT EXISTS users(id integer primary key, firstName text, lastName text, age text, country text, education text, userName text, password text)");
    
  });
})

.controller("appCtrl", function($scope, $cordovaSQLite){
